...
const Credits = ({ credits, accountsBalance, setCredits, creditsDescription, setCreditsDescription }) => {
    ...
    return (
        <div className="creditsDiv">
            ...
            <form onSubmit={e => {
                    ...
                    setCreditsDescription(`${e.target.description.value}: ${newCredits.value}`)
                }}>
